export default function TermsAndService() {
  return (
    <div className="container py-10 md:py-20">
      ...
      <div className="rounded-xl bg-white dark:bg-gray-800 shadow-lg p-6 sm:py-10 sm:p-[70px] md:p-10 lg:p-[70px] pb-0 space-y-10">
        <div>
        ...
        <div>
          ...
          <p className="text-base leading-relaxed text-body-color">
            You agree not to use the website in any way that violates any
            applicable law or regulation, infringes the rights of any third
            party, or is prohibited by these terms and conditions.
          </p>
        </div>
        <div>
          <h3 className="m-0 mb-4 text-2xl font-semibold text-dark sm:text-2xl">
